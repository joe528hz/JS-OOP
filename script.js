...
EV.prototype.brake = function () {
  console.log(
    `${this.make} going at ${(this.speed -= 5)} km/h, with a charge of ${
      this.charge
    }`
  );
};
...
//   calcAge() {
//     console.log(
//       `I'm ${2024 - this.birthYear} years old, but as a student I feel like ${
...
// const martha = new StudentCl('Martha Jones', 2002, 'Information Technology');
// martha.introduce();
// martha.calcAge();
...
const acc1 = new Account('Joel', 'PHP', 1111);
